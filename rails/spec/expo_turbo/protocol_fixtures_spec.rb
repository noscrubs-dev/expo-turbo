...
RSpec.describe "shared protocol fixtures" do
  before do
    manifest_path = File.join(ExpoTurboProtocolFixturesSpec::PROTOCOL_DIRECTORY, "compatibility-manifest.json")
    skip "shared protocol fixtures require repository protocol sources" unless File.file?(manifest_path)
  end
