...
The current screen renders a small registered native component tree from XML and includes interactive ordered Stream and Frame response updates. It exercises stable node subscriptions plus renderer error containment; fixture transport, inspector controls, and real Rails mode land in later implementation gates.
