...
- [ ] Remaining successful-control semantics: automatic XML/DOM control discovery, browser select defaulting and option-text value derivation, files, image coordinates, automatic or inherited `dirname` resolution and complete eligible-control coverage, and form-associated custom elements.
