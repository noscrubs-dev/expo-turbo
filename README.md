...
- [ ] Destination-aware form submission coordination and response application: shared document/Frame request ownership, target resolution, matching-Frame and Turbo Stream dispatch, `204`/blank-`201` completion, redirected canonical GET, unsafe-response enforcement, error outcomes, and authoritative `422` rendering.
