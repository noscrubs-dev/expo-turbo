...
- [ ] Remaining Turbo link/navigation behavior: host-router URL/history integration, root-scoped visitability, fragment/anchor navigation and scrolling, disabled/method/Stream/confirmation/action metadata, explicit non-HTTP scheme policies, snapshot cache/restoration, and preload/prefetch.
