...
- [x] Explicit React form ownership and live native control registration with current-value updates, activated-submitter collection, nearest-form isolation, Strict Mode replay safety, and Stream child-update/same-ID replacement cleanup.
