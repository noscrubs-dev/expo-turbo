...
- [ ] Remaining Turbo link/navigation behavior: host-router URL/history synchronization, explicit `replace`/`restore` visits, fragment/anchor navigation and scrolling, method/Stream-generated form links with functional confirmation, action metadata, native download/non-current browsing-context adapters, snapshot cache/restoration, and preload/prefetch.
