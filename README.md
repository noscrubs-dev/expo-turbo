...
- [ ] Remaining Turbo link/navigation behavior: Frame-scoped and named targets, `_top`, external/opt-out delegation, host-router URL/history integration, root-scoped visitability, fragment/anchor navigation and scrolling, disabled/method/Stream/confirmation/action metadata, snapshot cache/restoration, and preload/prefetch.
