...
- [ ] Destination-aware form transport coordination: shared document/per-Frame request ownership, pre-admission non-cancellation, same-destination supersession, different-Frame concurrency, exact proposal re-admission, and one-fetch unapplied candidates.
