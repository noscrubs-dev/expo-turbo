...
- [ ] Remaining Turbo link/navigation behavior: host-router URL/history synchronization, explicit `replace`/`restore` visits, fragment/anchor navigation and scrolling, method/Stream/confirmation/action metadata, snapshot cache/restoration, and preload/prefetch.
