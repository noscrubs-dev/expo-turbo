...
- [x] Host-neutral fetch, form-confirmation, navigation, Cable, lifecycle, visibility, focus, scroll, style, storage, observability, clock, and request-ID adapter contracts.
...
- [ ] Remaining form-submission lifecycle and presentation: live announcements and physical iOS/Android accessibility evidence.
