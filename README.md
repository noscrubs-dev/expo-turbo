...
> [!IMPORTANT]
> `0.1.3` is the stable release published on 2026-07-28. The package, gem,
...
| Stable publication | [`v0.1.3`](https://github.com/noscrubs-dev/expo-turbo/releases/tag/v0.1.3), published 2026-07-28 from one verified frozen npm/gem candidate |
