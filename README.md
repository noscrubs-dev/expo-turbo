...
- [ ] Remaining successful-control semantics: disabled fieldset/option inheritance, datalist ancestry, files, image coordinates, browser `_charset_` discovery/hidden-input eligibility, automatic or inherited `dirname` resolution and complete eligible-control coverage, and form-associated custom elements.
