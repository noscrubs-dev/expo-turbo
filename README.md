...
- [ ] Remaining successful-control semantics plus React form/field/submitter registration and native submission; GET/body encoding, uploads, validation/focus, redirects, and `422` rendering.
