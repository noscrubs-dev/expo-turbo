...
> [!IMPORTANT]
> `0.2.0` is the stable release published on 2026-08-12. The package, gem,
...
| Area | Current status |
| --- | --- |
| TypeScript package | [`expo-turbo@0.2.0`](https://www.npmjs.com/package/expo-turbo); stable and clean-imported through all public entrypoints |
| Rails gem | [`expo_turbo-rails` 0.2.0](https://rubygems.org/gems/expo_turbo-rails); clean-installed against `turbo-rails` `2.0.10` and `2.0.23` |
...
| Stable publication | [`v0.2.0`](https://github.com/noscrubs-dev/expo-turbo/releases/tag/v0.2.0), published 2026-08-12 from one verified frozen npm/gem candidate |
